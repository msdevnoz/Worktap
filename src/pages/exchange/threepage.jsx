  ...
  return (
    <>
      <div className="bg-gray-50 flex flex-col font-montserrat items-center justify-start mx-auto w-full">
        <header className="bg-gray-50_01 border border-gray-50_01 border-solid flex flex-col items-center justify-center md:px-5 shadow-bs2 w-full">
          <div className="flex flex-col gap-10 items-center justify-center mb-[30px] mt-[21px] mx-auto w-[69%]">
            <div className="flex md:flex-col flex-row md:gap-[51px] items-center justify-between w-full">
              <div className="flex md:flex-1 md:flex-col flex-row md:gap-10 items-center justify-between w-3/4 md:w-full">
                <div className="bg-gray-100 border border-gray-100 border-solid flex flex-row items-center justify-between pl-5 rounded-[30px] w-[43%] md:w-full">
                  <Text
            ...
            <div className="flex flex-row gap-5 items-center justify-start w-[24%] md:w-full">
              <Button
              ...
              <Button
                className="cursor-pointer flex items-center justify-center min-w-[175px]"
                rightIcon={
                  <Img
                    className="h-[15px] mt-px mb-0.5 ml-2.5"
                    src="images/img_mobilecancelmajor_1.svg"
                ...
                variant="outline"
              >
                <div className="!text-orange-300 font-medium leading-[normal] text-left text-sm">
                  Дизайн сайтов
                </div>
              </Button>
            </div>
        ...
        <List
          className="flex flex-col gap-10 items-center max-w-[1320px] mt-[50px] mx-auto md:px-5 w-full"
