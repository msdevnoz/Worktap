        ...
        <div className="flex flex-col items-center justify-start w-full">
            ...
            <div className="flex flex-col gap-[38px] items-center justify-start max-w-[1323px] mb-[92px] mx-auto md:px-5 w-full">
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between w-full">
                <div className="flex md:flex-1 flex-col items-start justify-start md:mt-0 mt-[72px] w-[46%] md:w-full">
                  ...
                  <div className="flex sm:flex-col flex-row gap-5 items-center justify-start mt-7 w-[74%] md:w-full">
                    <Button
                  ...
                  <div className="flex sm:flex-col flex-row gap-5 items-center justify-start mt-5 w-[68%] md:w-full">
                    <Button
                  ...
                  <div className="flex sm:flex-col flex-row gap-5 items-center justify-start mt-5 w-[89%] md:w-full">
                    <Button
          ...
          <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start max-w-[1288px] mt-[49px] mx-auto md:px-5 w-full">
            ...
            <div className="flex md:flex-1 flex-col items-start justify-start md:ml-[0] ml-[91px] w-[31%] md:w-full">
              <Img className="h-20" src="images/img_group.svg" alt="group" />
              <Text
          ...
          <div className="h-[734px] md:h-[833px] mt-[99px] md:px-5 relative w-full">
            ...
            <div className="absolute h-[734px] inset-[0] justify-center m-auto w-full">
              <div className="flex m-auto w-full">
                <div className="bg-gradient1  flex flex-col items-center justify-end my-auto p-[97px] md:px-10 sm:px-5 w-[44%]">
                  <Button
                    className="cursor-pointer font-bold leading-[normal] min-w-[100px] mt-[471px] rounded-[34px] text-2xl md:text-[22px] text-center sm:text-xl tracking-[0.48px]"
                    color="indigo_400"
                    size="xl"
                    variant="fill"
                  >
                ...
                <Img
                  className="h-[750px] ml-[-223px] my-auto object-cover w-[68%] z-[1]"
                  src="images/img_workspacewith.png"
                  alt="workspacewith"
                />
              </div>
              <div className="absolute flex flex-col items-start justify-start left-[2%] top-[7%] w-[28%]">
                <Text
                ...
                ></Input>
                <Text
                  className="mt-[100px] text-gray-50 text-xl tracking-[0.10px]"
                  size="txtMontserratSemiBold10"
                >
